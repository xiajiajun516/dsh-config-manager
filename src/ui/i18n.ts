...
export const uiZh = {
  ...
  // 导入结果页（2026-09）：总览之外的结构化两块 —— 需要关注的项 + 逐分区明细
  'report.problems': '需要你关注（{count}）',
  'report.sectionDetail': '分区明细',
  'report.other': '其它',
  'report.fullText': '完整文本报告（含逐项原因）',
  'report.secrets': '密钥：',
  ...
  // 结果报告徽章与动作按钮（UI-01/02/03：原先硬编码英文 included/excluded/encrypted/
  // no secrets/redacted 与原始动作 id）
  'report.includedCount': '已包含 {count}',
  'report.excludedCount': '未包含 {count}',
  'report.badgeEncrypted': '已加密',
  'report.badgeNoSecrets': '不含密钥',
  'report.badgeRedacted': '{count} 项已脱敏',
  'report.rollback': '回滚',
  'report.action.fixIssues': '查看失败项',
  'report.action.viewDetails': '查看详情',
  'report.includedSections': '已包含的分区',
  'report.excludedSections': '未包含的分区',
  'report.warnings': '注意事项',
  'report.unit.namespaces': '个命名空间',
  'report.unit.files': '个文件',
  'report.unit.servers': '个服务器',
  'report.unit.providers': '个 Provider',
  'report.unit.plugins': '个插件',
  'report.unit.patchLines': '行补丁',
  'report.unit.patchFiles': '个补丁文件',
  'report.unit.localTarballs': '个本地包',
  'report.unit.prompts': '条提示词',
  'report.unit.workspaces': '个工作区',
  'report.unit.credentials': '项凭据状态',
  'report.unit.notes': '条说明',
  ...
  'error.fallback': '操作失败',
  'error.requestTimeout': '请求超时（{seconds} 秒）：未在时限内收到宿主响应，请重试',
  ...
  'progress.syncing': '正在同步配置…',
  'progress.backingUp': '正在备份配置…',
  'progress.restoring': '正在恢复快照…',
  'progress.switchingProfile': '正在切换配置档案…',
  'progress.recovering': '正在恢复/回滚…',
  'progress.done': '已完成',
  'progress.failed': '已失败',
  // 快照
  ...
  'sync.pushPreviewCredentials': '本次推送包含真实凭据值（已随载荷整体加密；远端只见密文）。',
  ...
  'consult.dryRun': '只读分析',
  'consult.blockers': '{count} 项硬阻断（不处理无法安全导入）',
  'consult.attention': '{count} 项需处理',
...
export const uiEn: Record<UiTextKey, string> = {
  ...
  'report.problems': 'Needs your attention ({count})',
  'report.sectionDetail': 'Per-section detail',
  'report.other': 'Other',
  'report.fullText': 'Full text report (with per-item reasons)',
  ...
  'report.includedCount': '{count} included',
  'report.excludedCount': '{count} excluded',
  'report.badgeEncrypted': 'encrypted',
  'report.badgeNoSecrets': 'no secrets',
  'report.badgeRedacted': '{count} redacted',
  'report.rollback': 'Rollback',
  'report.action.fixIssues': 'View failures',
  'report.action.viewDetails': 'View details',
  'report.includedSections': 'Included sections',
  'report.excludedSections': 'Excluded sections',
  'report.warnings': 'Warnings',
  'report.unit.namespaces': 'namespace(s)',
  'report.unit.files': 'file(s)',
  'report.unit.servers': 'server(s)',
  'report.unit.providers': 'provider(s)',
  'report.unit.plugins': 'plugin(s)',
  'report.unit.patchLines': 'patch line(s)',
  'report.unit.patchFiles': 'patch file(s)',
  'report.unit.localTarballs': 'local package(s)',
  'report.unit.prompts': 'prompt(s)',
  'report.unit.workspaces': 'workspace(s)',
  'report.unit.credentials': 'credential status item(s)',
  'report.unit.notes': 'note(s)',
  ...
  'error.requestTimeout': 'Request timed out ({seconds}s): the host did not respond in time, please retry',
  ...
  'progress.syncing': 'Syncing configuration...',
  'progress.backingUp': 'Backing up configuration...',
  'progress.restoring': 'Restoring snapshot...',
  'progress.switchingProfile': 'Switching profile...',
  'progress.recovering': 'Recovering / rolling back...',
  'progress.done': 'Done',
  ...
  'sync.pushPreviewCredentials': 'This push includes real credential values (encrypted with the payload; the remote only ever sees ciphertext).',
  ...
  'consult.blockers': '{count} hard blocker(s) (cannot import safely until resolved)',
  'consult.attention': '{count} item(s) need attention',
