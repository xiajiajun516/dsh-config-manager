...
export const uiZh = {
  ...
  'report.tombstonedSkipped': '已按删除记录跳过 {count} 项（tombstone）',
  'report.included': '已包含：',
  'report.excluded': '未包含：',
  'report.security': '安全：',
  ...
  'progress.calculatingChecksums': '正在计算校验和…',
  ...
  'snapshots.confirmRestore': '确认恢复？当前文件将先备份到快照的 pre-restore 文件夹；插件经官方 dsh plugin remove 卸载。',
  'snapshots.execute': '立即恢复',
  ...
  'snapshots.selectHint': '选择一个快照预览其恢复计划（dry-run，零写入）：',
...
export const uiEn: Record<UiTextKey, string> = {
  ...
  'report.tombstonedSkipped': '{count} item(s) skipped by deletion records (tombstone)',
  ...
  'progress.calculatingChecksums': 'Calculating checksums...',
