...
export const zh = {
  ...
  'detail.import': '确认导入',
  'detail.back': '返回列表',
  // 条目导入审阅（2026-09：市场通道与导入页**同一套**选择语义 —— 级联树、默认全选、
  // 「全选」含高风险分区；风险由就地警示 + 免责声明 + 导入前快照 + 导入后回滚承担。
  // 原「逐分区批准（高风险默认不勾）」的 detail.approval.* / detail.noApproval 键随之删除。）
  'review.pickTitle': '选择要导入的内容',
  'review.highRiskHint': '已勾选高风险分区（{sections}）：该条目来自公共仓库、未经官方审核，导入会在本机安装插件 / 写入文件 / 注入全局指令。导入前会创建可回滚快照。',
  'review.changeTitle': '本次将改动的内容',
  'review.changeCount': '已选 {selected}/{total} 项',
  'review.changeWillChange': '将改动 {count} 项',
  'review.changeUnchanged': '已一致 {count} 项',
  'review.changeEmpty': '该条目没有可勾选的内容项。',
  'review.rowWillChange': '将改动',
  'review.rowUnchanged': '已一致',
  'review.rowExcluded': '不导入',
  'review.conflictHint': '有 {count} 项冲突（本机已存在且内容不同）待决策；未决策项按「保留本机」处理，不会覆盖现有内容。',
  'review.conflictOpen': '逐项决策',
  'review.conflictClose': '收起决策',
  'review.nothingSelected': '未勾选任何内容，无法导入',
  'review.rollback': '回滚到导入前快照',
  'review.rollbackHint': '把本机配置恢复到本次导入之前（快照由导入流程第一步创建）。',
  'review.snapshotMissing': '本次导入没有可用快照，无法回滚。',
  'review.rollbackConfirmTitle': '回滚到导入前快照？',
  'review.rollbackConfirmMessage': '将把本机配置恢复为「{item}」导入前的状态（快照 {id}）。本次导入写入的内容会被覆盖。',
  'review.rollbackConfirm': '确认回滚',
  'review.rollbackDone': '已回滚到导入前快照',
  'review.rollbackReport': '回滚报告',
  'review.rollbackRestored': '已恢复 {count} 项',
  'review.rollbackRemovedPlugins': '移除插件 {count} 个',
  'review.rollbackFailed': '失败 {count} 项',
  'review.rollbackManual': '需人工处理 {count} 项',
  // 分步流程（P1）：预览 → 选择内容 →（冲突）→ 确认 → 结果。
  // 为什么要分步：市场条目实测 3 分区 / 61 个计划项，同屏会出现三重滚动（弹窗 + 树 + 摘要）。
  'review.step.preview': '预览',
  'review.step.select': '选择内容',
  'review.step.conflicts': '冲突',
  'review.step.confirm': '确认',
  'review.step.result': '结果',
  'review.stepAria': '第 {current} 步，共 {total} 步',
  'review.filterAria': '按内容筛选',
  'review.filter.all': '全部',
  'review.filter.willChange': '将改动',
  'review.filter.highRisk': '高风险',
  'review.filter.unselected': '未勾选',
  'review.filterEmpty': '当前筛选下没有条目。',
  'review.sectionUnits': '已选 {selected}/{total} 个条目',
  'review.excludedCount': '已取消 {count} 项',
  'review.next': '下一步',
  'review.back': '上一步',
  'review.nextSelect': '选择要导入的内容',
  'review.confirmTitle': '确认将导入的内容',
  'review.confirmHint': '点「确认导入」后引擎先创建可回滚快照，再按上面的勾选执行；未勾选的项不会写入。',
  'review.resultTitle': '导入结果',
  'review.resultOk': '成功写入 {count} 项',
  'review.resultFailed': '失败 {count} 项',
  'review.reviewAgain': '返回重新选择',
  ...
  'disclaimer.download.text': '你即将从公共网络市场下载配置并导入本地。\n\n下载内容属于不可信输入：未经官方审核、可能包含风险（安装插件 / 写入文件 / 修改设置）。\n· 选择内容页逐项列出「本次将改动什么」，并就地标出高风险分区，请核对后再确认；\n· 各分区（含高风险）默认已勾选：取消勾选即不导入、也不进快照；\n· 导入会先自动创建快照，导入后可一键回滚；\n· 请核对来源与内容后再确认导入。',
  'disclaimer.install.text': '你即将把配置从你的公开仓库装回本地。\n\n该内容属于你此前上传的配置，但同样会经过安全校验与内容选择（默认全选）：\n· 选择页会就地标出高风险分区，取消勾选即不导入、也不进快照；\n· 导入前自动创建快照，导入后可一键回滚。',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  // Item import review (2026-09: the market channel now shares the import page's selection
  // semantics — cascade tree, select-all by default, "Select all" includes high-risk sections;
  // risk is carried by the inline warning + disclaimer + pre-import snapshot + rollback).
  'review.pickTitle': 'Choose what to import',
  'review.highRiskHint': 'High-risk sections selected ({sections}): this item comes from a public repository without official review, and importing installs plugins / writes files / injects global instructions on this machine. A rollback snapshot is created before the import.',
  'review.changeTitle': 'What this import will change',
  'review.changeCount': '{selected}/{total} item(s) selected',
  'review.changeWillChange': '{count} will change',
  'review.changeUnchanged': '{count} identical',
  'review.changeEmpty': 'This item has no selectable content items.',
  'review.rowWillChange': 'Will change',
  'review.rowUnchanged': 'Identical',
  'review.rowExcluded': 'Not imported',
  'review.conflictHint': '{count} conflict(s) (already present locally with different content) need a decision; undecided items keep your current config and are not overwritten.',
  'review.conflictOpen': 'Decide each one',
  'review.conflictClose': 'Hide decisions',
  'review.nothingSelected': 'Nothing selected — cannot import',
  'review.rollback': 'Roll back to pre-import snapshot',
  'review.rollbackHint': 'Restores this machine to its state before the import (the snapshot is taken by the first step of the import).',
  'review.snapshotMissing': 'This import has no usable snapshot, so it cannot be rolled back.',
  'review.rollbackConfirmTitle': 'Roll back to the pre-import snapshot?',
  'review.rollbackConfirmMessage': 'This restores the machine to its state before “{item}” was imported (snapshot {id}). Everything this import wrote will be overwritten.',
  'review.rollbackConfirm': 'Roll back now',
  'review.rollbackDone': 'Rolled back to the pre-import snapshot',
  'review.rollbackReport': 'Rollback report',
  'review.rollbackRestored': '{count} item(s) restored',
  'review.rollbackRemovedPlugins': '{count} plugin(s) removed',
  'review.rollbackFailed': '{count} failed',
  'review.rollbackManual': '{count} need manual handling',
  // Stepwise flow (P1): preview → select → (conflicts) → confirm → result.
  'review.step.preview': 'Preview',
  'review.step.select': 'Select',
  'review.step.conflicts': 'Conflicts',
  'review.step.confirm': 'Confirm',
  'review.step.result': 'Result',
  'review.stepAria': 'Step {current} of {total}',
  'review.filterAria': 'Filter by content',
  'review.filter.all': 'All',
  'review.filter.willChange': 'Will change',
  'review.filter.highRisk': 'High risk',
  'review.filter.unselected': 'Not selected',
  'review.filterEmpty': 'No items match the current filter.',
  'review.sectionUnits': '{selected}/{total} item(s) selected',
  'review.excludedCount': '{count} excluded',
  'review.next': 'Next',
  'review.back': 'Back',
  'review.nextSelect': 'Choose what to import',
  'review.confirmTitle': 'Confirm the selected content',
  'review.confirmHint': 'On confirm the engine takes a rollback snapshot first, then applies exactly what is selected above; unchecked items are never written.',
  'review.resultTitle': 'Import result',
  'review.resultOk': '{count} item(s) written',
  'review.resultFailed': '{count} item(s) failed',
  'review.reviewAgain': 'Back to selection',
  ...
  'disclaimer.download.text': 'You are about to download configs from a public network market and import them locally.\n\nDownloaded content is untrusted input: not officially reviewed and may carry risks (installing plugins / writing files / changing settings).\n· The selection step lists what each item will change and flags high-risk sections in place — review them before confirming;\n· Every section (high-risk ones included) starts selected: unchecking means it is neither imported nor snapshotted;\n· A snapshot is auto-created before import and one-click rollback is available afterwards;\n· Please verify the source and content before confirming the import.',
  'disclaimer.install.text': 'You are about to reinstall configs from your public repo to this machine.\n\nThis is content you uploaded before, but it still goes through the same validation and content selection (all selected by default):\n· High-risk sections are flagged in the selection step; unchecking them excludes them from the import and the snapshot;\n· A snapshot is auto-created before import and one-click rollback is available afterwards.',
