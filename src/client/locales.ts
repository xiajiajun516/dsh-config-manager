...
export const zh = {
  ...
  'import.decrypt.title': '解密备份',
  'import.decrypt.hint': '此备份包含加密的凭据，必须输入导出时设置的加密密码才能解锁并继续导入。',
  'import.decryptArchive.title': '解锁加密备份',
  'import.decryptArchive.hint': '此备份已整体加密（整个文件被密码保护）。输入导出时设置的密码才能解密并继续导入；密码仅本次使用，绝不落盘。',
  'import.decryptArchive.passwordPlaceholder': '输入备份加密密码',
  'import.decryptArchive.unlock': '解锁并继续',
  'import.decryptArchive.unlocking': '解锁中…',
  'import.decrypt.passwordPlaceholder': '输入备份加密密码',
  'import.decrypt.verify': '验证密码',
  'import.decrypt.verifying': '验证中…',
  'import.decrypt.verified': '密码正确，解密将恢复 {count} 个凭据',
  'import.decrypt.verifiedEmpty': '密码正确（该备份没有可恢复的凭据）',
  'import.decrypt.previewHint': '加密备份：下一步需输入导出时的加密密码才能解锁凭据。',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  'import.decrypt.title': 'Decrypt Backup',
  'import.decrypt.hint': 'This backup contains encrypted credentials. Enter the password you set at export time to unlock it and continue.',
  'import.decryptArchive.title': 'Unlock Encrypted Backup',
  'import.decryptArchive.hint': 'This backup is fully encrypted (the whole file is password-protected). Enter the password set at export time to decrypt and continue; the password is used once and never written to disk.',
  ...
  'import.decrypt.passwordPlaceholder': 'Enter backup encryption password',
  'import.decrypt.verify': 'Verify password',
  'import.decrypt.verifying': 'Verifying…',
  'import.decrypt.verified': 'Password OK — decryption restores {count} credential(s)',
  'import.decrypt.verifiedEmpty': 'Password OK (this backup holds no restorable credentials)',
  'import.decrypt.previewHint': 'Encrypted backup: the next step requires the export-time encryption password to unlock credentials.',
