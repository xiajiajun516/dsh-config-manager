...
export const zh = {
  ...
  'overview.quick.backupSkipped': '备份已跳过：{reason}',
  'overview.quick.backupSkip.disabled': '定时备份未启用',
  'overview.quick.backupSkip.running': '已有备份正在运行',
  'overview.quick.backupSkip.conflict': '另一项任务正在运行',
  'overview.quick.backupSkip.mutationLocked': '环境锁被占用',
  'overview.quick.backupSkip.unknown': '当前无法执行',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  'overview.quick.backupSkipped': 'Backup skipped: {reason}',
  'overview.quick.backupSkip.disabled': 'Scheduled backups are disabled',
  'overview.quick.backupSkip.running': 'A backup is already running',
  'overview.quick.backupSkip.conflict': 'Another task is already running',
  'overview.quick.backupSkip.mutationLocked': 'The environment lock is in use',
  'overview.quick.backupSkip.unknown': 'The backup cannot run right now',
