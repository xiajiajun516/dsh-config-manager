...
export const zh = {
  ...
  'history.subtitle': '统一记录全部破坏性/迁移操作（导入/恢复/回滚/档案/同步/备份/快照操作），只可追加、不可修改或删除，跨重启持久，可查询可导出。',
  'history.empty': '暂无迁移记录。执行导入、恢复、档案切换、同步应用或备份后，这里会出现审计记录。',
  ...
  'history.kind.profile-create': '档案新建',
  'history.kind.profile-select': '设置下次启动档案',
  ...
  'history.kind.backup-manual': '手动备份',
...
export const en = {
  ...
  'history.kind.profile-create': 'Profile created',
  'history.kind.profile-select': 'Next-launch profile set',
  ...
  'history.kind.backup-manual': 'Manual backup',
